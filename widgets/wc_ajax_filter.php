...
class Anps_WC_Ajax_Filter_Widget extends WP_Widget {
 ...
 <section class="sidebar-widget">
      ...
      <div class="sidebar-widget__menu-group-1" id="visible-color">
        <ul>
          <li>
            <label ><input type="checkbox" value="green" class="color_inp" /><span class="green color"></span>Green</label><span class="num">2</span>
          </li>
          <li>
            <label><input type="checkbox" value="blue" class="color_inp" /><span class="blue color"></span>Blue</label><span class="num">2</span>
          </li>
          <li>
            <label ><input type="checkbox" value="red" class="color_inp" /><span class="red color"></span>Red</label><span class="num">2</span>
          </li>
        </ul>
      </div>
    </div>
